"""
Django settings for learning_quest_41048 project.
...
ROOT_URLCONF = 'learning_quest_41048.urls'
...
WSGI_APPLICATION = 'learning_quest_41048.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "learning_quest_41048 API",
    "DESCRIPTION": "API documentation for learning_quest_41048 App",
    "VERSION": "v1",
}
